...
export const ECON_ESSAY_PLACEMENT = {
  ...
  Q004: [{ a: 'indirect-tax', e: 'elasticity' }, { a: 'positive-externality' }, { e: 'laffer' }],
  ...
  Q014: [{ a: 'revenue-curves', e: 'elasticity' }, { a: 'price-discrimination' }, { a: 'kinked-demand' }],
  Q015: [{ a: 'public-goods' }, {}],
  ...
  Q028: [{ a: 'trade-union' }, { a: 'monopsony' }, { a: 'labour-market' }],
