...
export const ECON_ESSAY_ANSWERS_P1 = {
  Q011: A(
    ...
    [
      [
        ...
        'The shift depends on the type of investment. Only net investment above depreciation expands the capital stock; if much of the spending replaces worn-out capital, the frontier barely moves. Investment in property or financial assets adds little productive capacity, and capital that stands idle because demand is weak or skills are lacking shifts the frontier on paper but not in practice.',
      ],
      [
  ...
  Q014: A(
    ...
    [
      ...
      [
        'Knowledge of PED makes third-degree price discrimination possible. If a firm can separate customers into groups with different elasticities and prevent resale, it charges a higher price to the inelastic group and a lower price to the elastic group, earning more total revenue and profit than a single price would. Airlines charge business travellers booking late more than leisure travellers booking early; cinemas offer student and off-peak prices. The relative elasticities determine the price gap. Without an estimate of PED for each segment, none of this is possible.',
  ...
  Q026: A(
    ...
    [
      [
        'A firm that can separate its market sets MR equal to MC in each sub-market. In the sub-market with inelastic demand it charges a high price; in the elastic sub-market a lower one. Consumers in the inelastic group - business travellers, peak-time commuters, patients needing a patented drug - pay more than they would under a single price, so their consumer surplus falls and is transferred to the firm as higher profit. Where the firm can identify individual willingness to pay, as online platforms increasingly can, the discrimination approaches first degree and extracts almost all consumer surplus. In these cases consumers as a group lose and the firm gains, and the practice is a symptom of market power being exploited.',
      ...
      [
        ...
        'Nothing compels the firm to use the profit in these ways; it may simply be distributed to shareholders. Discrimination can also be used predatorily, pricing low in a contested segment to drive out a rival and then raising prices, in which case consumers lose in the long run. Regulators treat some forms - such as personalised pricing based on data profiling - as unfair regardless of the efficiency arguments.',
      ],
    ],
  ...
  Q030: A(
    ...
    [
      ...
      [
        ...
        'Private owners may prefer short-run returns. Water companies in England took on large debts, paid substantial dividends and under-invested in infrastructure, with sewage discharges and Thames Water’s financial distress the visible results; several rail franchises failed and were taken back into public operation. Where the regulator is captured or lacks information, the private firm’s dynamic efficiency is not assured, and the state may end up carrying the risk anyway.',
      ],
      [
        'The comparison depends on the industry’s structure. Where the market can be made contestable, privatisation with deregulation is likely to raise all three kinds of efficiency. Where the industry is a natural monopoly, the gains are limited to whatever the regulator can extract, and the losses - monopoly pricing, reduced universal service, fragmentation of a network that worked better as a whole - can outweigh them; the break-up of British Rail into track, operators and rolling-stock companies is widely judged to have raised costs. Distribution also matters: privatisation transfers assets built with taxpayers’ money to shareholders, and the sale price and subsequent profits determine whether the public gained.',
