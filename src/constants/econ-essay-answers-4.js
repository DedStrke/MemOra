...
export const ECON_ESSAY_ANSWERS_4 = {
  ...
  Q080: A(
    ...
    [
      ...
      [
        'Whether it is possible to achieve all objectives simultaneously therefore depends on the state of the economy and the time horizon considered. In an economy operating with significant spare capacity (a negative output gap), demand-side stimulus can raise growth and reduce unemployment with little inflationary or import cost, since idle resources can be brought into use without straining capacity - here, several objectives can be achieved together in the short run.',
        'In an economy already near full capacity, the classic trade-offs re-emerge in the short run, and reconciling all objectives then depends on supply-side policy gradually raising capacity over the medium to long run, alongside careful demand management in the interim - genuinely achieving every objective simultaneously, indefinitely, is rare, but a government can reduce the SIZE of the conflicts through well-targeted supply-side policy even if it cannot eliminate them entirely.',
      ],
    ],
  ...
  Q084: A(
    ...
    [
      ...
      [
        ...
        'Following a major supply shock - a sharp rise in energy or import prices, as seen more recently - the curve itself shifts, and unemployment and inflation can rise together exactly as in the 1970s, meaning demand management alone cannot address the inflation without a further, separate cost in unemployment, since the trade-off it is being asked to manage has become worse, not merely moved along.',
      ],
    ],
