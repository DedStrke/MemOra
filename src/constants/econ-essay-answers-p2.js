...
export const ECON_ESSAY_ANSWERS_P2 = {
  ...
  Q048: A(
    ...
    'Economic development means rising living standards, health and education as well as output. Governments can pursue it through market-orientated strategies (trade liberalisation, attracting foreign investment, microfinance, privatisation), interventionist ones (infrastructure, human capital, buffer stock schemes to stabilise commodity prices, managed exchange rates), or others again - industrialisation along the lines of the Lewis model of moving labour from low-productivity agriculture into manufacturing, tourism, Fairtrade schemes, aid and debt relief. Trade promotes development by letting countries specialise according to comparative advantage, earn foreign exchange and attract investment and technology; aid promotes it by transferring resources that fill the savings, foreign-exchange and skills gaps that keep poor countries in a poverty trap. The most successful developing economies of the past fifty years grew through trade rather than aid, but trade requires conditions that aid can help to create, and the two are more often complements than substitutes.',
    [
      [
