...
export const ECON_ESSAY_ANSWERS_P2 = {
  ...
  Q038: A(
    ...
    'The circular flow of income shows money moving between households and firms; injections - investment, government spending and exports - add to the flow while withdrawals - saving, taxation and imports - remove from it. When injections exceed withdrawals, national income rises until withdrawals, which depend on income, catch up. An increase in injections therefore raises AD and, with spare capacity, raises real output, which is economic growth in the short run. Whether it produces sustained growth depends on the response of withdrawals, on capacity and on what kind of injection it is.',
    [
      [
  ...
  Q050: A(
    ...
    'A financial crisis is a sudden collapse in the value of financial assets and in the willingness of institutions to lend, with severe effects on the real economy. The 2008 crisis arose from excessive lending, high leverage, asymmetric information about securitised assets and the expectation that large banks would be rescued. Regulation since then - higher capital and liquidity requirements, ring-fencing, stress tests, macroprudential oversight - aims to make banks safer and to remove the incentives that produced the crisis. It can reduce the likelihood and severity of a future crisis; whether it can prevent one is a different question.',
    [
      [
  ...
  Q051: A(
    ...
    [
      [
        ...
        'The cost depends on what the deficit finances. Borrowing for infrastructure, education or research raises future productive potential and tax revenue, so the debt can pay for itself; borrowing for current consumption does not. It also depends on the interest rate relative to the growth rate: when growth exceeds the cost of borrowing, as it did for much of the 2010s, the debt ratio can fall even with a persistent deficit.',
      ],
      [
