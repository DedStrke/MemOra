  ...
  Q076: A(
    ...
    [
      ...
      [
        ...
        'Many interventions have, in practice, corrected market failure at a cost well below the welfare loss they addressed: competition policy that has broken up genuine monopolistic abuses, or vaccination programmes that internalise a clear and well-measured positive externality, show that the risk of government failure does not make all intervention counter-productive - only intervention that is poorly targeted, poorly measured, or captured by narrow interests.',
      ],
      [
